...
export default function Signin() {
  ...
  const demoAccounts = [
    { email: "demo@E-Cart.com", password: "demo123", name: "Demo User" },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-md mx-auto px-4">
        {/* Back Button */}
        <Link to="/" className="inline-flex items-center text-orange-500 hover:text-blue-700 mb-6 text-sm sm:text-base">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">Sign in to your E-Cart account</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/forgot-password" className="text-orange-500 hover:text-blue-700 text-sm sm:text-base">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              ...
              className="w-full bg-orange-500 text-white py-2 sm:py-3 rounded-lg font-semibold hover:bg-orange-400 transition-colors disabled:bg-blue-400 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm sm:text-base">
              ...
              <Link to="/signup" className="text-orange-500 hover:text-blue-700 font-medium">
                Sign Up
              </Link>
            </p>
          </div>
