          ...
          {wishlist.map((item) => (
            ...
            >
              ...
              <div className="p-4 sm:p-6">
                <Link to={`/product/${item.id}`}>
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 hover:text-orange-500 transition-colors line-clamp-2">
                    {item.name}
                  </h3>
                </Link>
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-orange-500 text-white py-2 px-4 rounded-lg font-medium hover:bg-orange-400 transition-colors flex items-center justify-center text-sm sm:text-base"
                  >
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8">
            ...
            <button
              ...
              className="bg-orange-500 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-orange-400 transition-colors text-sm sm:text-base"
            >
              Add All to Cart
            </button>
          </div>
