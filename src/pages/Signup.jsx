      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6 text-sm sm:text-base">
            Welcome to E-Cart! You're being redirected to the homepage...
          </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-md mx-auto px-4">
        ...
        <Link
          to="/signin"
          className="inline-flex items-center text-orange-500 hover:text-blue-700 mb-6 text-sm sm:text-base"
        >
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">Join E-Cart and start shopping today</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label className="flex items-start text-sm sm:text-base">
                ...
                <span className="text-gray-700">
                  I agree to the{" "}
                  <Link to="/terms" className="text-orange-500 hover:text-blue-700 underline">
                    Terms and Conditions
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-orange-500 hover:text-blue-700 underline">
                    Privacy Policy
                  </Link>
                </span>
              </label>
            ...
            <button
              ...
              className="w-full bg-orange-500 text-white py-2 sm:py-3 rounded-lg font-semibold hover:bg-orange-400 transition-colors disabled:bg-orange-400 disabled:cursor-not-allowed flex items-center justify-center text-sm sm:text-base"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm sm:text-base">
              ...
              <Link to="/signin" className="text-orange-500 hover:text-blue-700 font-medium">
                Sign In
              </Link>
            </p>
          </div>
