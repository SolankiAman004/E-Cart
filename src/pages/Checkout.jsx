      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 max-w-md w-full text-center">
          ...
          <div className="space-y-3">
            <button
              onClick={() => navigate("/products")}
              className="w-full bg-orange-500 text-white py-3 rounded-lg hover:bg-orange-400 transition-colors text-sm sm:text-base"
            >
              Continue Shopping
            </button>
            <button
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center text-orange-500 hover:text-blue-700 mb-6 sm:mb-8"
        >
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 lg:p-8">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8">
                ...
                <button
                  ...
                  className="w-full bg-orange-500 text-white py-3 sm:py-4 rounded-lg font-semibold hover:bg-orange-400 transition-colors flex items-center justify-center text-sm sm:text-base disabled:bg-orange-400 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 sticky top-8">
              ...
              <div className="mt-6 space-y-3">
                <div className="flex items-center text-xs sm:text-sm text-gray-600">
                  <Shield className="h-6 w-6 sm:h-4 sm:w-4 mr-2 text-green-600" />
                  Secure checkout
                </div>
                <div className="flex items-center text-xs sm:text-sm text-gray-600">
                  <Truck className="h-6 w-6 sm:h-4 sm:w-4 mr-2 text-orange-500" />
                  Free returns within 30 days
                </div>
                {paymentMethod === "cod" && (
                  <div className="flex items-center text-xs sm:text-sm text-gray-600">
                    <Banknote className="h-6 w-6 sm:h-4 sm:w-4 mr-2 text-orange-600" />
                    Pay on delivery
                  </div>
                )}
              </div>
