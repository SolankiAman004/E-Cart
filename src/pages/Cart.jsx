...
import { Plus, Minus, X, ArrowLeft, Heart } from "lucide-react"
      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-2">
            {/* Replaced ShoppingCart icon with Unsplash image */}
            <img 
              src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Empty shopping cart"
              className="h-46 w-full sm:h-full sm:w-46 object-cover rounded-md mx-auto mb-6 "
            />
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          ...
          <Link to="/products" className="text-orange-500 hover:text-blue-700 font-medium text-sm sm:text-base">
            Continue Shopping
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                  ...
                  <div key={item.id} className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link to={`/product/${item.id}`}>
                          <h3 className="text-base sm:text-lg font-semibold text-gray-900 hover:text-orange-500 transition-colors mb-2">
                            {item.name}
                          </h3>
                        </Link>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 sticky top-8">
              ...
              <Link
                to="/checkout"
                className="w-full bg-orange-500 text-white py-3 sm:py-4 rounded-lg font-semibold hover:bg-orange-400 transition-colors text-center block text-sm sm:text-base"
              >
                Proceed to Checkout
              </Link>
