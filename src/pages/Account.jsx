...
export default function Account() {
  ...
  <div className="relative w-full max-w-md">
    ...
    {/* Card */}
    <div className="relative bg-white/90 backdrop-blur rounded-3xl shadow-2xl px-6 py-8 sm:px-10 sm:py-12">

      {/* Header */}
      <div className="text-center">
        <div className="relative mx-auto mb-6 w-20 h-20">
          <div className="absolute inset-0 rounded-full bg-orange-300 blur-xl opacity-50"></div>
          <div className="relative bg-gradient-to-br from-orange-100 to-orange-200 w-full h-full rounded-full flex items-center justify-center ring-4 ring-white">
            <User className="h-9 w-9 text-orange-500" />
          </div>
        </div>

        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">
          Welcome to <span className="text-orange-500">E-Cart</span>
        </h1>
      ...
      <div className="mt-10 space-y-4">
        <Link
          to="/signin"
          className="group w-full inline-flex items-center justify-center rounded-xl bg-orange-500 text-white py-3.5 font-semibold text-sm sm:text-base shadow-lg hover:bg-orange-400 transition-all"
        >
          Sign In
        </Link>
        ...
        <Link
          to="/signup"
          className="w-full inline-flex items-center justify-center rounded-xl border border-gray-300 py-3.5 font-semibold text-gray-700 text-sm sm:text-base hover:bg-gray-50 transition-all"
        >
          Create Account
        </Link>
      </div>
      ...
      {/* Trust Badges */}
      <div className="mt-10 grid grid-cols-3 gap-4 text-center text-xs sm:text-sm text-gray-600">
                ...
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      className="flex items-center text-orange-500 hover:text-blue-700 text-sm sm:text-base"
                    >
                  ...
                  <form onSubmit={handleProfileUpdate}>
                    ...
                    {isEditing && (
                      <div className="mt-6">
                        <button
                          type="submit"
                          className="bg-orange-500 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-orange-400 transition-colors text-sm sm:text-base"
                        >
                          Save Changes
                        </button>
                      </div>
